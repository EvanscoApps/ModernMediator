...
{
    /// <summary>
    /// Modern ModernMediator interface for loosely-coupled messaging.
    /// 
    /// USAGE (in order of preference):
    /// 1. DI Container: services.AddModernMediator();
    /// 2. Singleton:    ModernMediator.Instance
    /// 3. Factory:      ModernMediator.Create()  (for isolated instances)
    /// </summary>
    public interface IModernMediator : IDisposable
    {
        /// <summary>
